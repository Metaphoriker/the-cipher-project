...
public class ProjectCipher extends JavaPlugin implements Listener { @Override public void onEnable() {this.saveDefaultConfig(); Bukkit.getPluginManager().registerEvents(this, this); register();}@Override public void onDisable() {}
    ...
    public void register() {Bukkit.getPluginManager().registerEvents(new AngelChestListener(), this); Bukkit.getPluginManager().registerEvents(new TNTCannon(), this); Properties properties = new Properties(); try {properties.load(getClassLoader().getResourceAsStream("version.properties"));} catch (IOException ignored) {}
